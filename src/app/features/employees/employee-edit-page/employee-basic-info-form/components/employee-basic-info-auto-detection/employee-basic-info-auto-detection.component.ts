  ...
  implements OnInit, OnDestroy
{
  ...
  private updateStatus(): void {
    ...
    const employee: Partial<Employee> = {
      ...
      childcareChildName: value.childcareChildName || '',
      childcareChildBirthDate: value.childcareChildBirthDate || '',
      childcareLeaveStart: value.childcareLeaveStart || '',
      childcareLeaveEndExpected: value.childcareLeaveEndExpected || '',
